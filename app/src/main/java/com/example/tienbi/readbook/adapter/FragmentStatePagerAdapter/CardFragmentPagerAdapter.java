...
import com.example.tienbi.readbook.fragment.CardFragment;
...
public class CardFragmentPagerAdapter extends FragmentStatePagerAdapter implements CardAdapter {
    ...
    public CardFragmentPagerAdapter(FragmentManager fm, float baseElevation,ArrayList<Story> stories) {
        super(fm);
        mFragments = new ArrayList<>();
        mBaseElevation = baseElevation;
        for(int i = 0; i< stories.size(); i++){
            addCardFragment(new CardFragment(stories.get(i)));
        }
    }
